...
from apps.webapp.views.comment import CommentAddView, CommentDeleteView
from apps.webapp.views.post import PostListView, PostAddView, PostDeleteView, PostUpdateView, PostLikeView, PostDetailView
